...
import MaterialUISwitch from "./common/CustomToggle";
        ...
        <div className="h-[85%] xl:w-[15%] hidden md:flex flex-col justify-between bg-gray-100 fixed top-15 left-15 p-3 rounded-2xl">
          ...
          <div>
            ...
            <button
              ...
              className="h-[35px] hidden xl:block w-full bg-gray-900 text-white rounded-md mt-2 cursor-pointer hover:bg-gray-800 transtion"
            >
              Log Out
            </button>
          </div>
